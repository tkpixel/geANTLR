...
public class LookAtTestLookup11 extends Application {
            ...
            for (Node cell : area.lookupAll(".content > *")) {
                try {
                    ...
                    if (textFlow != null && textFlow.getLayoutInfo() != null) {
                        ...
                        Rectangle2D r = caretInfo.getSegmentAt(0);
                        javafx.geometry.Bounds bounds = textFlow.localToScene(new javafx.geometry.BoundingBox(r.getMinX(), r.getMinY(), r.getWidth(), r.getHeight()));
