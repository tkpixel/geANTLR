...
public class LookAtUpdateBracketLine2 extends Application {
    ...
    public void start(Stage stage) {
        try {
            ...
            TextPos openPos = TextPos.ofLeading(2, 7); // `{`
            TextPos closePos = TextPos.ofLeading(3, 0); // `}`
            TextPos indentPos = TextPos.ofLeading(2, 0); // `F`
