...
public class LookAtTextCell4 extends Application {
    ...
    public void start(Stage stage) {
        try {
            ...
            for (Node vflow : area.lookupAll(".vflow")) {
                if (vflow instanceof javafx.scene.Parent pvflow) {
                    for (Node content : pvflow.getChildrenUnmodifiable()) {
